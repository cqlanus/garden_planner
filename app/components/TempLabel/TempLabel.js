        ...
        return (
            <g>
                <g>
                    ...
                    <text
                        x={x}
                        y={this._calcHeight(gdd50[idx].gdd)}
                        style={{ fontSize: 10 }}>{`${gdd50[idx].gdd}°F`}</text>
                    <text
                        x={x}
                        y={this._calcHeight(gdd40[idx].gdd)}
                        style={{ fontSize: 10 }}>{`${gdd40[idx].gdd}°F`}</text>
                    <text
                        x={x}
                        y={this._calcHeight(minTemps[idx].temp)}
                        style={{ fontSize: 10 }}>{`${
                            minTemps[idx].temp
                        }°F`}</text>
                    <text
                        x={x}
                        y={this._calcHeight(maxTemps[idx].temp)}
                        style={{ fontSize: 10 }}>{`${
                            maxTemps[idx].temp
                        }°F`}</text>
                </g>
